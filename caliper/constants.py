...
CALIPER_VERSION = 'http://purl.imsglobal.org/ctx/caliper/v1p1/Context'
...
OUTCOME_PROFILE_ACTIONS.update(OUTCOME_EVENT_ACTIONS)
OUTCOME_PROFILE_ACTIONS.update(VIEW_EVENT_ACTIONS)
