...
ENTITY_CONTEXTS = {
    ENTITY_TYPES['AGENT']: CALIPER_VERSION,
    ENTITY_TYPES['ANNOTATION']: CALIPER_VERSION,
    ENTITY_TYPES['ASSESSMENT']: CALIPER_VERSION,
    ENTITY_TYPES['ASSESSMENT_ITEM']: CALIPER_VERSION,
    ENTITY_TYPES['ASSIGNABLE_DIGITAL_RESOURCE']: CALIPER_VERSION,
    ENTITY_TYPES['ATTEMPT']: CALIPER_VERSION,
    ENTITY_TYPES['AUDIO_OBJECT']: CALIPER_VERSION,
    ENTITY_TYPES['BOOKMARK_ANNOTATION']: CALIPER_VERSION,
    ENTITY_TYPES['CHAPTER']: CALIPER_VERSION,
    ENTITY_TYPES['COURSE_OFFERING']: CALIPER_VERSION,
    ENTITY_TYPES['COURSE_SECTION']: CALIPER_VERSION,
    ENTITY_TYPES['DIGITAL_RESOURCE']: CALIPER_VERSION,
    ENTITY_TYPES['DIGITAL_RESOURCE_COLLECTION']: CALIPER_VERSION,
    ENTITY_TYPES['DOCUMENT']: CALIPER_VERSION,
    ENTITY_TYPES['ENTITY']: CALIPER_VERSION,
    ENTITY_TYPES['EPUB_CHAPTER']: CALIPER_VERSION,
    ENTITY_TYPES['EPUB_PART']: CALIPER_VERSION,
    ENTITY_TYPES['EPUB_SUB_CHAPTER']: CALIPER_VERSION,
    ENTITY_TYPES['EPUB_VOLUME']: CALIPER_VERSION,
    ENTITY_TYPES['FILLINBLANK']: CALIPER_VERSION,
    ENTITY_TYPES['FORUM']: CALIPER_VERSION,
    ENTITY_TYPES['FRAME']: CALIPER_VERSION,
    ENTITY_TYPES['GROUP']: CALIPER_VERSION,
    ENTITY_TYPES['HIGHLIGHT_ANNOTATION']: CALIPER_VERSION,
    ENTITY_TYPES['IMAGE_OBJECT']: CALIPER_VERSION,
    ENTITY_TYPES['LEARNING_OBJECTIVE']: CALIPER_VERSION,
    ENTITY_TYPES['LTI_SESSION']: CALIPER_VERSION,
    ENTITY_TYPES['MEDIA_LOCATION']: CALIPER_VERSION,
    ENTITY_TYPES['MEDIA_OBJECT']: CALIPER_VERSION,
    ENTITY_TYPES['MEMBERSHIP']: CALIPER_VERSION,
    ENTITY_TYPES['MESSAGE']: CALIPER_VERSION,
    ENTITY_TYPES['MULTIPLECHOICE']: CALIPER_VERSION,
    ENTITY_TYPES['MULTIPLERESPONSE']: CALIPER_VERSION,
    ENTITY_TYPES['ORGANIZATION']: CALIPER_VERSION,
    ENTITY_TYPES['PAGE']: CALIPER_VERSION,
    ENTITY_TYPES['PERSON']: CALIPER_VERSION,
    ENTITY_TYPES['READING']: CALIPER_VERSION,
    ENTITY_TYPES['RESPONSE']: CALIPER_VERSION,
    ENTITY_TYPES['RESULT']: CALIPER_VERSION,
    ENTITY_TYPES['SCORE']: CALIPER_VERSION,
    ENTITY_TYPES['SELECTTEXT']: CALIPER_VERSION,
    ENTITY_TYPES['SESSION']: CALIPER_VERSION,
    ENTITY_TYPES['SHARED_ANNOTATION']: CALIPER_VERSION,
    ENTITY_TYPES['SOFTWARE_APPLICATION']: CALIPER_VERSION,
    ENTITY_TYPES['TAG_ANNOTATION']: CALIPER_VERSION,
    ENTITY_TYPES['TEXT_POSITION_SELECTOR']: CALIPER_VERSION,
    ENTITY_TYPES['THREAD']: CALIPER_VERSION,
    ENTITY_TYPES['TRUEFALSE']: CALIPER_VERSION,
    ENTITY_TYPES['VIDEO_OBJECT']: CALIPER_VERSION,
    ENTITY_TYPES['WEB_PAGE']: CALIPER_VERSION
}
...
EVENT_CONTEXTS = {
    EVENT_TYPES['ANNOTATION_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['ASSESSMENT_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['ASSESSMENT_ITEM_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['ASSIGNABLE_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['EVENT']: CALIPER_VERSION,
    EVENT_TYPES['FORUM_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['MEDIA_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['MESSAGE_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['NAVIGATION_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['GRADE_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['SESSION_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['THREAD_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['TOOL_LAUNCH_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['TOOL_USE_EVENT']: CALIPER_VERSION,
    EVENT_TYPES['VIEW_EVENT']: CALIPER_VERSION,
}
...
EVENT_CLASSES = {
    ...
    EVENT_TYPES['TOOL_LAUNCH_EVENT']: 'caliper.events.ToolLaunchEvent',
...
## map context onto event types
MARKER_CONTEXTS = {
    MARKER_TYPES['ASSIGNABLE']: CALIPER_VERSION,
    MARKER_TYPES['GENERATABLE']: CALIPER_VERSION,
    MARKER_TYPES['REFERRABLE']: CALIPER_VERSION,
    MARKER_TYPES['TARGETABLE']: CALIPER_VERSION,
}
...
TOOL_LAUNCH_PROFILE_ACTIONS = {}
TOOL_LAUNCH_PROFILE_ACTIONS.update(TOOL_LAUNCH_EVENT_ACTIONS)
...
CALIPER_ACTIONS.update(TOOL_LAUNCH_PROFILE_ACTIONS)
