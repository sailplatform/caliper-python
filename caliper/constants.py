...
CALIPER_PROFILES = {
    ...
    'RESOURCE_MANAGEMENT_PROFILE': 'ResourceManagementProfile',
...
PROFILE_CONTEXTS[CALIPER_PROFILES['FEEDBACK_PROFILE']] = [_CALIPER_PROFILE_EXT_CTXTS.format(
    CALIPER_PROFILES['FEEDBACK_PROFILE'])]
...
PROFILE_CONTEXTS[CALIPER_PROFILES['SURVEY_PROFILE']] = [_CALIPER_PROFILE_EXT_CTXTS.format(
    CALIPER_PROFILES['SURVEY_PROFILE'])]
...
CALIPER_PROFILES_FOR_CONTEXTS[CALIPER_CORE_CONTEXT] = CALIPER_PROFILES['BASIC_PROFILE']
...
CALIPER_PROFILES_FOR_EVENT_TYPES = {
    ...
    EVENT_TYPES['FEEDBACK_EVENT']: CALIPER_PROFILES['FEEDBACK_PROFILE'],
    ...
    EVENT_TYPES['QUESTIONNAIRE_EVENT']: CALIPER_PROFILES['SURVEY_PROFILE'],
    EVENT_TYPES['QUESTIONNAIRE_ITEM_EVENT']: CALIPER_PROFILES['SURVEY_PROFILE'],
    EVENT_TYPES['RESOURCE_MANAGEMENT_EVENT']: CALIPER_PROFILES['RESOURCE_MANAGEMENT_PROFILE'],
    EVENT_TYPES['SEARCH_EVENT']: CALIPER_PROFILES['SEARCH_PROFILE'],
    EVENT_TYPES['SESSION_EVENT']: CALIPER_PROFILES['SESSION_PROFILE'],
    EVENT_TYPES['SURVEY_EVENT']: CALIPER_PROFILES['SURVEY_PROFILE'],
    EVENT_TYPES['SURVEY_INVITATION_EVENT']: CALIPER_PROFILES['SURVEY_PROFILE'],
